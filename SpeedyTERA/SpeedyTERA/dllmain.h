...
#define TERA_BASE 0x00400000

#define ADDR_ENCRYPT_FN1 TERA_BASE+0x015626B0
#define ADDR_CALL_ENCRYPT_FN1_1 TERA_BASE+0x01561AE4
#define ADDR_CALL_ENCRYPT_FN1_2 TERA_BASE+0x01562A02

#define ADDR_ENCRYPT_FN2 TERA_BASE+0x01561030
#define ADDR_CALL_ENCRYPT_FN2_1 TERA_BASE+0x01561382
#define ADDR_CALL_ENCRYPT_FN2_2 TERA_BASE+0x01561BD1

#define ADDR_NET_BUFFER TERA_BASE+0x022CCE38
